...
.source.python .variable.parameter {
  ...
  <body class='markdown-preview'><h2 id="ncurses-traffic-lights">ncurses Traffic Lights</h2>
<p>Just an interesting project serving as an excuse to learn ncurses that I have
been meaning to do for a long time.</p>
<p>This code observes the sequences seen here in Canada (and elsewhere in North 
America), so let&#39;s hope I remember the sequences correctly!</p>
<p>I wrote something like this on Windows years ago, and that repo can be found
<a href="https://github.com/ButchDean/TrafficLights">here</a>. It was a game programming 
exercise that I created for others.</p>
<p>Anyway, time for more fun!</p></body>
</html>
